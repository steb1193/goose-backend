...
- **[README бэкенда](./DEPLOYMENT.md)** - переменные окружения, конфигурация БД, развертывание сервера
- **[README фронтенда](https://github.com/steb1193/goose-frontend/blob/master/DEPLOYMENT.md)** - переменные окружения, настройки прокси, развертывание клиента
...
2. **тапать есть можно только в рамках активного рануда**
